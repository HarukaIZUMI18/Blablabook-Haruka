...
| title        | Titre du livre                   | TEXT             | Max 100 caractères             | NOT NULL                             |
| cover        | URL ou chemin vers l'image       | VARCHAR          | Max 255 caractères             | NOT NULL                             |
| author       | Nom de l'auteur du livre         | VTEXT            | Max 100 caractères             | NOT NULL                             |
| description  | Description du livre             | TEXT             | Max 255 caractères             | NOT NULL                             |
| publish_year | Année de publication du livre    | SMALLINT         | YYYY                           | NOT NULL                             |
